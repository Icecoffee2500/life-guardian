...
- [ ] 인쇄 대화상자에서 **배율 100%**, 여백 **없음**. 배율이 "용지에 맞춤"이면 폭이 어긋난다
- [ ] 한 장 뽑아 **팔 길이에서 읽히는지** 확인. 감열 인쇄에는 중간 계조가 없어서
      회색 글씨는 얼룩이 된다 — 영수증 안에서 회색을 쓰지 않는 이유다(`globals.css` `.receipt`)
- [ ] 영수증 한 장 길이는 약 32cm. 롤 여유와 커터 위치를 여기에 맞춘다
